    ...
    <main className="mx-auto max-w-4xl px-6 py-24 md:py-32">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <p className="text-ink-soft">
          ...
          <br />
          Ao acessar ao site da Escola Cera, concorda em cumprir estes termos de serviço, todas as
          leis e regulamentos aplicáveis ​​e concorda que é responsável pelo cumprimento de todas as
          leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido de
        ...
        <p className="text-ink-soft mt-6">
          ...
          (informações ou software) no site Escola Cera, apenas para visualização transitória
        ...
        <p className="text-ink-soft mt-6">
          ...
          <br />
          Os materiais no site da Escola Cera são fornecidos 'como estão'. Escola Cera não oferece
        ...
        <p className="text-ink-soft mt-6">
          ...
          <br />
          Em nenhum caso a Escola Cera ou seus fornecedores serão responsáveis ​​por quaisquer danos
          ou falhas.
        </p>
      </div>
    </main>
