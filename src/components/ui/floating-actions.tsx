...
export function FloatingActions() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show when scrolling down, hide at the very top
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="flex size-14 items-center justify-center rounded-full bg-ink text-paper shadow-lg transition-transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-ink/50 active:scale-95"
